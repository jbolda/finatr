...
const styles = tv({
  base: 'dark:bg-zinc-900/70 dark:backdrop-blur-2xl dark:backdrop-saturate-200 forced-colors:bg-[Canvas] shadow-2xl rounded-xl bg-clip-padding border border-black/10 dark:border-white/15 text-slate-700 dark:text-zinc-300',
  variants: {
    isEntering: {
