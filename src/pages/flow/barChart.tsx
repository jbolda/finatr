...
let barBuild = {
  ...
  drawAxis: function (svg, dateRange, max_domain) {
    // create axis
    let xAxis = d3
  ...
  drawBar: function ({
    ...
    let color = (d) =>
      d3.scaleLinear().domain([0, data.length]).range(colors(d));
  ...
  drawLine: function ({ svg, selector, dateRange, data, max_domain, tooltip }) {
