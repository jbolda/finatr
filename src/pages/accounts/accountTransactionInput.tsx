          ...
          render={({
            ...
            >
              ...
              <FieldGroup
                ...
                touched={touched}
              >
                <Field as={Select} name="debtAccount" id="debt-debtAccount">
              ...
              <FieldGroup
                ...
                touched={touched}
              >
                <Field as={Input} name="description" id="debt-description" />
              </FieldGroup>
              ...
              >
                ...
                {values.ending === 'after Number of Occurrences' ? (
                  ...
                  <FieldGroup
                    ...
                    touched={touched}
                  >
                    <Field as={Input} name="end" id="debt-end" type="date" />
                  </FieldGroup>
                ) : null}
              </FieldGroup>
              ...
              <FieldGroup
                ...
                touched={touched}
              >
                <Field as={Input} type="number" name="cycle" id="debt-cycle" />
              </FieldGroup>
