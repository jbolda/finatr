...
export const fieldGroupStyles = tv({
  extend: focusRing,
  base: 'group flex items-center h-9 dark:bg-zinc-900 forced-colors:bg-[Field] border-2 rounded-lg overflow-hidden',
  ...
  return (
    <RACInput
      ...
      className={composeTailwindRenderProps(
        props.className,
        'px-2 py-1.5 flex-1 min-w-0 outline outline-0 dark:bg-zinc-900 text-sm text-gray-800 dark:text-zinc-200 disabled:text-gray-200 dark:disabled:text-zinc-600'
      )}
    />
  );
}
